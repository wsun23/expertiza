module ReportFormatterHelper
  ...
  def user_summary_report(line)
    if @user_tagging_report[line.user.name].nil?
      @user_tagging_report[line.user.name] = VmUserAnswerTagging.new(line.user, line.no_total, line.no_inferred, line.no_taggable, line.no_tagged, line.no_not_tagged, line.percentage)
    else
